...
export const SecurityChart: React.FC<SecurityChartProps> = ({
  data,
  title = 'Security Findings by Category',
  loading = false,
}) => {
  return (
    <Card className="h-[350px] flex flex-col justify-between">
      <div className="mb-2">
        ...
        <p className="text-xs text-gray-500">Distribution of vulnerabilities and coding threats</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex-1 flex items-center justify-center text-sm text-gray-455 italic">
          No security warnings reported.
        </div>
      ) : (
