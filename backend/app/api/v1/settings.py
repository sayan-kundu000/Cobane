...
class UserPreferenceUpdate(BaseModel):
    theme: Optional[str] = Field(default=None, pattern="^(light|dark)$", description="User preference theme selection (light or dark)")
    receiving_notifications: Optional[bool] = Field(default=None, description="Whether the user wants to receive system notifications")
