...
class NormalizedFinding(BaseModel):
    ...
    recommendation: Optional[str] = Field(None, description="Actionable suggestion detailing how to address the warning")
    ...
    confidence: str = Field(default="medium", description="Accuracy confidence level classification (low, medium, high)")
...
class StaticAnalysisReport(BaseModel):
    ...
    findings: List[NormalizedFinding] = Field(default_factory=list, description="Aggregated lists of parsed static issues")
