...
class StaticAnalysisService:
    ...
    def run_all(self, file_path: str) -> dict:
        ...
        return {
            "pylint": {"score": report.pylint_score, "conventions": [], "warnings": pylint_warnings},
            "bandit": {"score": "FAIL" if report.bandit_issues_count > 0 else "PASS", "issues": bandit_issues},
            "radon": {"score": "A" if report.metrics.maintainability_index >= 80.0 else "B", "cc": radon_cc},
        }
