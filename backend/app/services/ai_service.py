...
class AIService:
    ...
    async def generate_review(
        ...
        result = await orchestrator.conduct_review(
            filename=filename, language=language, code_content=_code_content, findings=findings or [], metrics=metrics
        )
        ...
        return {"provider": self.provider, "summary": result.summary, "suggestions": suggestions}
